...
- **Name**: Ivana
- **Machine**: Mac
- **Experience**: Has built websites before
- **Motivation**: End to end workflow — wants to learn the full process from idea to production-ready app
- **Terminal comfort**: 4 / 5
